...
| Unity 場景組裝 / 遊戲邏輯 / Build | `engineering/unity-team` | ✅ 可用（透過 `unity-mcp` 連接 Unity Editor，操作邏輯整併自 [kiro-unity-accelerator](https://github.com/hoycdanny/kiro-unity-accelerator) 最佳實踐，見 root README「Unity MCP 整合詳解」） |
